...
createGroup.addEventListener('submit', async(e) => {
    ...
    await axios.post('http://52.72.239.54:3000/group/addGroup', {name}, {headers: {'Authorization': token}});
    alert('Group created !!');
});
...
addUserToGroup.addEventListener('submit', async(e) => {
    ...
    try {
        await axios.post('http://52.72.239.54:3000/group/addUserToGroup',obj, {headers: {'Authorization':token}});
...
removeUserFromGroup.addEventListener('submit', async(e) => {
    ...
    try {
        await axios.post('http://52.72.239.54:3000/group/removeUserFromGroup',obj, {headers: {'Authorization':token}});
